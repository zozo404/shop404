    ...
    <form class="mt-4" method="POST">
      <div class="flex flex-col items-center justify-center lg:justify-start">
        ...
        <div class="mb-6">
          ...
          <input required type="name" class="block w-full px-4 py-2 text-xl font-normal text-gray-700 bg-white bg-clip-padding border border-solid border-gray-300 rounded transition ease-in-out m-0 focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none" name="image" placeholder="Nom de l'image (.png)" />
          <p class="text-center text-white block w-full px-4 py-2 text-xl font-normal bg-clip-padding">Alt de l'image du produit</p>
          <input type="name" class=" mt-2 block w-full px-4 py-2 text-xl font-normal text-gray-700 bg-white bg-clip-padding border border-solid border-gray-300 rounded transition ease-in-out m-0 focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none" name="alt" placeholder="Alt de l'image" required />
        </div>
        <!-- Nom produit input -->
        <div class="mb-6">
          <p class="text-center text-white block w-full px-4 py-2 text-xl font-normal bg-clip-padding">Titre du produit</p>
          <input type="text" class="block w-full px-4 py-2 text-xl font-normal text-gray-700 bg-white bg-clip-padding border border-solid border-gray-300 rounded transition ease-in-out m-0 focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none" name="nom" placeholder="Titre du produit" required />
        </div>
        <!-- Prix input -->
        <div class="mb-6">
          <p class="text-center text-white block w-full px-4 py-2 text-xl font-normal bg-clip-padding">Prix du produit</p>
          <input type="number" class="block w-full px-4 py-2 text-xl font-normal text-gray-700 bg-white bg-clip-padding border border-solid border-gray-300 rounded transition ease-in-out m-0 focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none" name="prix" placeholder="Prix du produit en €" required />
        </div>
        <!-- Description input -->
        <div class="mb-6">
